#!/bin/bash
tmux new -d -s session_0_1
tmux send-keys -t session_0_1 "source venv-python/bin/activate" C-m
tmux send-keys -t session_0_1 "export CUDA_VISIBLE_DEVICES=0" C-m
tmux send-keys -t session_0_1 "python sparch/run_exp.py --sweep_id S3_SHD_runs/pj1sj9r0" C-m
...
do
  ...
  do
    ...
    tmux send-keys -t $SESSION_NAME "python sparch/run_exp.py --sweep_id S3_SHD_runs/pj1sj9r0" C-m
